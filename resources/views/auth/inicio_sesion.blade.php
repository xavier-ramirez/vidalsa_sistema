            ...
            <div class="login-container-form">
                <form id="loginForm" action="{{ route('login.post') }}" method="POST">
                    ...
                    <div id="btnBiometricLogin" style="display:none;flex-direction:column;align-items:center;gap:6px;margin-top:16px;cursor:pointer;">
                        <div style="width:64px;height:64px;border-radius:50%;background:#00004d;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 12px rgba(0,0,77,.3);transition:transform 0.15s ease,box-shadow 0.15s ease;">
