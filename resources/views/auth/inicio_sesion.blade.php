        ...
        <div class="login-container-float-center">
            ...
            <div class="login-container-form">
                <form id="loginForm" action="{{ route('login.post') }}" method="POST">
                    ...
                    @endif
                    <div class="button-login-container" style="display:flex;align-items:center;gap:10px;">
                        <button type="submit" id="btnOnlineLogin" class="btn-maquinaria-primary" style="flex:1;">Iniciar sesión</button>
                        <div id="btnBiometricLogin" style="display:none;flex-direction:column;align-items:center;gap:4px;cursor:pointer;">
                            <div style="width:44px;height:44px;border-radius:50%;background:linear-gradient(135deg,#0067b1,#00337a);display:flex;align-items:center;justify-content:center;box-shadow:0 3px 10px rgba(0,51,122,.3);transition:transform 0.15s ease,box-shadow 0.15s ease;">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="#fff"><path d="M17.81 4.47c-.08 0-.16-.02-.23-.06C15.66 3.42 14 3 12.01 3c-1.98 0-3.86.47-5.57 1.41-.24.13-.54.04-.68-.2-.13-.24-.04-.55.2-.68C7.82 2.52 9.86 2 12.01 2c2.13 0 3.99.47 6.03 1.52.25.13.34.43.21.67-.09.18-.26.28-.44.28zM3.5 9.72c-.1 0-.2-.03-.29-.09-.23-.16-.28-.47-.12-.7.99-1.4 2.25-2.51 3.75-3.3 3.09-1.63 6.81-1.63 9.91 0 1.5.79 2.76 1.9 3.75 3.3.16.22.11.54-.12.7-.23.16-.54.11-.7-.12-.9-1.26-2.04-2.27-3.39-2.98-2.8-1.47-6.16-1.47-8.97 0-1.34.71-2.48 1.72-3.38 2.98-.1.14-.25.21-.44.21zm.01 6.9c-.09 0-.18-.02-.25-.08-.24-.14-.32-.44-.18-.68C4.16 14 5.56 12.62 7.3 11.74c3.52-1.78 7.86-1.78 11.38 0 1.73.88 3.14 2.26 4.22 4.12.14.23.06.54-.18.68-.23.14-.54.06-.68-.18-.96-1.68-2.23-2.9-3.77-3.68-3.19-1.61-7.13-1.61-10.31 0-1.55.78-2.82 2-3.78 3.68-.1.16-.26.24-.43.24zM12 21c-.28 0-.5-.22-.5-.5v-1c0-.28.22-.5.5-.5s.5.22.5.5v1c0 .28-.22.5-.5.5z"/></svg>
                            </div>
                            <span id="bioLabel" style="font-size:9px;font-weight:600;color:#6e7781;letter-spacing:0.2px;white-space:nowrap;">Identificación biométrica</span>
                        </div>
                    </div>
