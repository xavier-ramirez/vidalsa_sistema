                ...
                <div id="hostFieldWrap" style="display:none;">
                        <div>
                            ...
                            <div id="auxHostPicker" style="position: relative;">
                                ...
                                <div id="hostSelectedCard" style="display:none; background:linear-gradient(135deg,#eff6ff 0%,#dbeafe 100%); border:1px solid #93c5fd; border-radius:10px; padding:6px 10px; align-items:center; gap:10px;">
                                    ...
                                    <div style="flex:1; min-width:0;">
                                        <div style="display:flex; align-items:baseline; gap:8px; min-width:0;">
                                            <span id="hostSelectedPrimary" style="font-weight:800; color:#1e293b; font-size:13.5px; line-height:1.25; white-space:nowrap;"></span>
                                            <span id="hostSelectedTertiary" style="color:#64748b; font-size:11px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; display:none;"></span>
                                        </div>
                                        <div id="hostSelectedSecondary" style="color:#475569; font-size:12px; line-height:1.25; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"></div>
                                    </div>
                                    <button type="button" onclick="window.auxHostClear && window.auxHostClear()" title="Cambiar" style="background:white; border:1px solid #cbd5e1; color:#475569; cursor:pointer; border-radius:6px; padding:4px 8px; display:flex; align-items:center; gap:4px; font-size:11.5px; font-weight:600; flex-shrink:0;">
                                        <i class="material-icons" style="font-size:15px;">swap_horiz</i> Cambiar
                                    </button>
                                </div>
                            </div>
