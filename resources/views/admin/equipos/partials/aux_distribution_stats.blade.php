{{-- Distribucion por TIPO de AUXILIAR (modo aux de /admin/equipos). Mismo estilo
     visual que admin.equipos.partials.distribution_stats, pero con datos de
     auxiliares; al clickear filtra por ese tipo aux en el dropdown combinado
     (selectOption con valor 'tipo_aux:CODIGO'). $auxDistribucion = [['tipo','label','total'], ...]. --}}
