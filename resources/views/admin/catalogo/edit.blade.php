...
<div class="cat-create-wrapper" style="max-width: 1100px; margin: 0 auto; padding: 0 12px;">
    <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 16px;">
        <h1 class="page-title" style="text-align: center;">
            <span class="page-title-line2" style="color: #000;">Edición Catálogo {{ $catalogo->MODELO }}</span>
        </h1>
    </div>
        ...
        <form id="catalogoForm" action="{{ route('catalogo.update', $catalogo->ID_ESPEC) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-top: 30px; display: flex; gap: 12px; justify-content: center;">
                ...
                <button type="submit" class="btn-primary-maquinaria"
                    ...
                    onclick="event.preventDefault(); window.toast('Acceso denegado: No tienes permiso para actualizar este modelo.', 'error');"
                    @endcannot
                >
