...
-->
    ...
    <table width="100%" border="1" cellpadding="5" cellspacing="0">
        <thead>
            <tr bgcolor="#e6f2ff">
                <td width="5%"  align="center" style="width: 5%; font-size:8.5pt;"><b>N°</b></td>
                <td width="50%" align="center" style="width: 50%; font-size:8.5pt;"><b>DESCRIPCIÓN / EQUIPO</b></td>
                <td width="20%" align="center" style="width: 20%; font-size:8.5pt;"><b>MARCA</b></td>
                <td width="25%" align="center" style="width: 25%; font-size:8.5pt;"><b>SERIAL / PLACA</b></td>
            </tr>
        </thead>
        <tbody>
