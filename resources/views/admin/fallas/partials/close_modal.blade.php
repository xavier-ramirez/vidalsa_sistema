...
<div id="flCierreOverlay" class="fl-modal-overlay" onclick="if(event.target===this) window.flCerrarCierreModal()">
    <div class="fl-modal" style="max-width:460px;">
        ...
        <div class="fl-modal-body">
            <div id="flCierreMsg" style="font-size:13px; color:#475569; background:#fff7ed; border:1px solid #fed7aa; border-radius:10px; padding:10px 12px; text-align:center;"></div>
            <div style="font-size:12.5px; color:#64748b; text-align:center;">Al cerrar, el equipo vuelve a <strong>OPERATIVO</strong> (si no le quedan otros reportes abiertos).</div>
            <div>
            ...
            <div style="display:flex; gap:10px;">
                <button type="button" onclick="window.flCerrarCierreModal()"
                    style="height:44px; flex:1; display:inline-flex; align-items:center; justify-content:center; border:1px solid #e2e8f0; background:white; color:#475569; border-radius:10px; font-weight:700; cursor:pointer;">
                    Cancelar
                </button>
